...
export default function AdminMarkets() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-text mb-1">マーケット管理</h1>
        <p className="text-text-muted text-sm">オープン・締切済みマーケットの管理</p>
      </div>

      {active.length === 0 ? (
        <div className="text-center py-20 text-text-muted">管理対象のマーケットがありません</div>
      ) : (
